...
| 谁 | 读什么 |
|----|--------|
| AI（每轮） | 根目录 [AGENTS.md](../AGENTS.md)（路口）；不要开场读本目录全文 |
| AI（打开后端文件） | `.cursor/rules/backend.mdc` 自动注入导航 / 编码 / 测试 |
| AI（打开前端相关文件） | `frontend/AGENTS.md` + 匹配的 `.cursor/rules/frontend-*.mdc` |
